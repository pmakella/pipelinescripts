...
#   make Tophat alignment config file
    ...
    cp /glusterfs/users/pmakella/scripts/run_Tophat_alignment.hg.bid.ini  $dirname/run_Tophat_alignment.$BID.ini
...
#   make Quantification config file
    cp /glusterfs/users/pmakella/scripts/run_RNAseq_expr_analysis.hg.bid.ini  $dirname/run_RNAseq_expr_analysis.$BID.ini
    sed -i 's/BID/'"$BID"'/g' $dirname/run_RNAseq_expr_analysis.$BID.ini
    sed -i 's/RUNDATE/'"$RunDate"'/g' $dirname/run_RNAseq_expr_analysis.$BID.ini
    sed -i 's/SAMPLE/'"$Sample"'/g' $dirname/run_RNAseq_expr_analysis.$BID.ini
...
#whole genome
    cp /glusterfs/users/pmakella/scripts/run_RNAseq_expr_analysis_wholegenome.hg.bid.ini  $dirname/run_RNAseq_expr_analysis_wholegenome.$BID.ini
