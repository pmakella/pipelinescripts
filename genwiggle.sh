scriptsConfig=/usr/local/tools/run-Tophat-alignment/run_Tophat_alignment.scripts.ini
pmakella@kg12-compute-1:/glusterfs/users/pmakella$ cat scripts/genWig3.sh 
#!/binbashage : genWig.sh <dirname> <sequencedatafilename> 
